...
def payment(request):
    if request.method == 'POST':
        try:
            ...
            print(f"Travel Guide ID: {travel_guide_id}")
            ...
            # Get destination and travel guide
            try:
                destination = Destination.objects.get(id=destination_id)
                travel_guide = TravelGuide.objects.get(id=travel_guide_id)
                print(f"Found destination: {destination.name}")
                print(f"Found travel guide: {travel_guide.name}")
            except (Destination.DoesNotExist, TravelGuide.DoesNotExist) as e:
                print(f"Error: {str(e)}")
            ...
            # Set payment and booking status
